...
// the bulk of this, including all core functionality,
// was modified from
...
let imageRepository = new function() {
	...
	// Set images src
	// this.background.src = "images/space_bg.png";
	this.background.src = "/assets/space_bg-06b3028047d28aa5d686c11991b88cc00e64154cb89bf7a6a37ede97db663e09.png";
	this.spaceship.src = "/assets/ship-2351257c15cdd3ffe2da6ff52476520763c183306ec2990eb2890033a587cbd9.png";
	this.bullet.src = "/assets/bullet-a03c59b650dca2f44c04b093b539195e3c3362612c35d073b6aa1e8acc41992a.png";
	this.enemy.src = "/assets/enemy-acf1bb2ae29dd5bf7e5607c355711213f35987e628695f29462866c45b12a681.png";
	this.enemyBullet.src = "/assets/bullet_enemy-92e61034f253954b43123e9aa1da3a0234f79c0d2ab83ca34cf15dacbcb4f964.png";
}
...
function Drawable() {
	...
	this.speed = 0;
	this.canvasWidth = 0;
	this.canvasHeight = 0; this.collidableWith = "";
...
function Background() {
    ...
    this.y += this.speed;
		...
		this.context.drawImage(imageRepository.background, this.x - this.canvasWidth + 550, this.y - this.canvasHeight + 320);
...
function Game() {
	...
	this.init = function() {
		...
		if (this.bgCanvas.getContext) {
			...
			this.enemyBulletPool = new Pool(100);
			...
			this.backgroundAudio = new Audio("/assets/kick_shock-4e8176c48af6fc0fe194f56e86caba96ce186825c886b3e2562ab155eaf91f1e.wav");
			this.backgroundAudio.loop = true;
			this.backgroundAudio.volume = .25;
			this.backgroundAudio.load();

			this.gameOverAudio = new Audio("/assets/game_over-3243df26d9718a8458fa9accfce0a77e1ac02017614de4eb9a288ad9484fb7ba.wav");
	...
	this.updateScore = function() {
		...
		let u = $('.container').data('username');
		let score = {nickname: u, score: s};
		$.post( 'scores', score).done(function() {
...
function SoundPool(maxSize) {
	...
	this.init = function(object) {
		if (object == "laser") {
			for (let i = 0; i < size; i++) {
				// Initalize the object
				laser = new Audio("/assets/laser-6a2de2919f3ce32e6342d1a1ef6a5661dcad5062300c0273bf7e316236241126.wav");
				laser.volume = .12;
				laser.load();
				pool[i] = laser;
			}
			...
			for (let i = 0; i < size; i++) {
				let explosion = new Audio("/assets/explosion-ef62251b112f253d4b894d53ff37fed9ee14afe948f8a588811ca74bcda9f364.wav");
				explosion.volume = .1;
				explosion.load();
				pool[i] = explosion;
			}
